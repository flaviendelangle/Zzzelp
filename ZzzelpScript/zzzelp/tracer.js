function ZzzelpScriptTraceur(data, callback) {
	...
	this.get = function() {
		...
		if(!valeurs) {
			...
			new ZzzelpAjax({ method : 'GET', domain : 'fourmizzz', url : prefix + valeurs.valeur, addDOM : true },
	...
	this.sendZzzelp = function(mode) {
		...
		new ZzzelpAjax({ method : 'POST', domain : 'zzzelp', url : 'stockageTDC?', force : mode, data : form },
