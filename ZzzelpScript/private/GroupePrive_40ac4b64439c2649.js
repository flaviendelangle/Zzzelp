...
function ze_Amelioration_chat_prive(lieu) {
	var menu_CA = document.querySelectorAll('#formulaireChat .sur_une_ligne')[1],
		...
		BBCode = {
			...
			centrer : 	{ onclick : addBalises,  title : "Centrer", src : ZzzelpScript.url + "Images/center.png" },
			right : 	{ onclick : addBalises,  title : "Aligner à droite", src : ZzzelpScript.url + "Images/right.png" }, 
...
function ze_Affichage_traceur_Zzzelp(alliance, premier) {
	if(premier) {
		...
		Traceur.src = ZzzelpScript.url + '/Javascript/Traceur_prive.js';
